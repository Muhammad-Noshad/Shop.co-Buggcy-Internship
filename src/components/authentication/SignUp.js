...
const SignUp = () => {
  ...
  return (
    ...
    <p style={{
      "textAlign":"center",
      "marginBottom": "2em"
      }}>Sign up to continue </p>
    <form onSubmit={handleSubmit} autoComplete="off" className={isSubmitting? "disabled":""} encType="multipart/form-data">
      <FormField 
        label="First Name" 
        type="text" 
        id="firstName" 
      ...
      <FormField 
        ...
        onChange={ handleChange } 
        onBlur={ handleBlur } 
        error={ errors.dateOfBirth && touched.dateOfBirth? errors.dateOfBirth:false } 
      />
      <FormField 
        ...
        accept="image/*" 
        id="profilePic" 
        className={ errors.profilePic && touched.profilePic? "input-error":""} 
        value={ undefined } 
        onChange={ handleFileChange } 
        onBlur={ handleBlur } 
        error={ errors.profilePic && touched.profilePic? errors.profilePic:false } 
      />
      <FormField 
        label="Email" 
        type="email" 
      ...
      <p style={{
        "textAlign":"center",
        "marginTop": "2em"
        }}><strong><u>Already have an account? Sign in now!</u></strong></p>
      </Link>
      <button disabled={ isSubmitting } className={ isSubmitting? "disabled":"" } type="submit">Sign Up</button>
    </form>
